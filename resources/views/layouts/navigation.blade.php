    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links - Solo muestra Dashboard si está autenticado -->
                @auth
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route(auth()->user()->role . '.dashboard')" :active="request()->routeIs([
                        ...
                        <!-- Nuevo: Enlace Datos - Solo para alumnos -->
                        @if (auth()->user()->role === 'alumno')
                            <x-nav-link :href="route('alumno.datos')" :active="request()->routeIs('alumno.datos')">
                                {{ __('Mis Datos') }}
                            </x-nav-link>
                        @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-yellow-700 focus:outline-none transition ease-in-out duration-150">
