<div class="bg-white rounded-xl shadow-md overflow-hidden">
    ...
    <div
        ...
        <button wire:click="abrirModal"
            class="flex items-center bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition-all shadow hover:shadow-md">
    ...
    <!--Barra de Busqueda    w-full max-w-md"-->
    <div class="px-6 py-4 border-b border-gray-100">
        <div class="relative">
            ...
            <input type="text" wire:model.live="search" placeholder="Buscar empresa por cualquier campo..."
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tutor
                    </th>
                    ...
                    <form wire:submit.prevent="guardarEmpresa">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" wire:model="mail"
                                    class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                @error('mail')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                ...
                <div class="p-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 mt-2">¿Estás seguro de eliminar esta empresa? Esta acción
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        ...
                        <button wire:click="eliminarEmpresa"
