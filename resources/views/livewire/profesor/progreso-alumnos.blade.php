            ...
            @forelse($alumnos as $alumno)
                <div class="px-6 py-4">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span
                            class="text-sm font-medium {{ $alumno->progreso >= 80 ? 'text-green-600' : ($alumno->progreso >= 50 ? 'text-yellow-600' : 'text-red-600') }}">
                            {{ $alumno->progreso }}%
                        </span>
                    </div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <div class="bg-blue-600 h-2.5 rounded-full" style="width: {{ $alumno->progreso }}%"></div>
                    </div>
